...
public class ZermiaClientLocalBoot {
	
	public boolean bootStrapClient(String clientCode) throws IOException {
		ZermiaProperties props = new ZermiaProperties();
		props.loadProperties();
		String libs = ZermiaLibsLocation.getLibs();

		Logger.getLogger(ZermiaClientLocalBoot .class.getName()).log(Level.INFO, "Starting bootStrap for client");
		String command1="cmd.exe";
		String command2="/c start java -cp " + libs + " " + clientCode;
			 ...
			 new Thread() {
	                ...
	                public void run() {
	                    ...
	                    try {
	                        ...
	                        Logger.getLogger(ZermiaClientLocalBoot.class.getName()).
	                            log(Level.SEVERE,
	                            "BootStrap error");
	                    }
	                }
